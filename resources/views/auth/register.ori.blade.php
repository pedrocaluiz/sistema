                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="primeiroNome" class="col-form-label text-md-right">{{ __('Nome') }}</label>
                            <div class="col-md-6">
                         ...
                         <!--primeiroNome-->
                            ...
                            <div class="col-auto">
                                <label for="ultimoNome" class="col-form-label text-md-right">{{ __('Sobrenome') }}</label>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <select id="estado" class="form-control" name="estado" onchange="javascript:carregarMunicipios(this);">
                                </select>
                            </div>
                        </div> <!--estado-->

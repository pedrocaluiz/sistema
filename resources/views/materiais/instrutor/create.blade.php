          ...
          <legend>@lang('messages.informations'):</legend>
            <div class="row">
              ...
              <div class="form-group col-md-3">
                ...
                <select class="form-control " id="unidade_id" name="unidade_id" onchange="carregarMateriais(this)" required>
                    <option value="" disabled selected>SELECIONE</option>
                </select>
              </div>
            </div>
            ...
            <div id="tabs" class="nav-tabs-custom">
              <ul class="nav nav-tabs">
                ...
                <li class="active"><a href="#material1" data-toggle="tab" aria-expanded="true">Material</a></li>
              </ul>
                  ...
                  <fieldset>
                    ...
                    <div class="row">
                      ...
                      <div class="form-group col-md-2">
                        ...
                        <select class="form-control" id="tipoMat_id" name="tipoMat_id[]" required>
                            <option value="" disabled selected>SELECIONE</option>
                          @if(count($tiposMat) > 0)
                    ...
                    <div class="row">
                      ...
                      <div class="form-group col-md-4" id="URL1">
                        ...
                        <input id="pathMaterial1" type="file" class="form-control-file pathMaterial1" name="pathMaterial[]" required>
  ...
  <script type="text/javascript">
      $(function(){
          ...
          $(".fa-plus").click(function(){
              $(".nav-tabs").append(
                  '<li id="'+a+'"><a href="#material'+a+'" data-toggle="tab" id="ui-id-'+a+'">Material</a></li>'
              );
              $(".tab-content").append(
                    ...
                    <fieldset>
                      ...
                      <div class="row">
                        ...
                        <div class="form-group col-md-4" id="URL${a}">
                          <label class="pathMaterial${a}" for="pathMaterial${a}">Arquivo</label>
                          <input id="pathMaterial${a}" type="file" class="form-control-file pathMaterial${a}" name="pathMaterial[]" required>

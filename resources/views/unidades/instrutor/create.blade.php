...
@section('content')
  <form method="POST" action="{{ route('unidades.instrutor.store') }}" enctype="multipart/form-data" class="cadastro">
    @csrf
            ...
            <fieldset>
              ...
              <div class="row">
                ...
                <div class="form-group col-md-4">
                  ...
                  <input id="tituloUnidades" type="text" class="form-control" name="tituloUnidade" required>
                </div>
              </div>
            </fieldset>
          </div>

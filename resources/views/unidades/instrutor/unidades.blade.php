        ...
        <div class="col-md-12">
            <div class="box">
                                    ...
                                    <table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                                        ...
                                        @foreach ($unidades as $u)
                                            <tr>
                                                ...
                                                @endforeach
                                                <td>
                                                    <a href="/unidades/instrutor/{{$u->id}}/edit" class="btn btn=sm btn-primary acaoTxt">@lang('messages.edit')</a>
                                                    <a href="/unidades/instrutor/{{$u->id}}/edit" class="btn btn=sm btn-primary acaoIcon"><i class="fa fa-edit"></i></a>
                                                    <a class="btn btn=sm btn-danger acaoTxt" href="/unidades/instrutor/{{$u->id}}"
                                                       onclick="event.preventDefault();
                                                               document.getElementById('delete-form-{{$u->id}}').submit();">
                                                        @lang('messages.delete')
                                                    </a>
                                                    <a class="btn btn=sm btn-danger acaoIcon"href="/unidades/instrutor/{{$u->id}}"
                                                       onclick="event.preventDefault();
                                                               document.getElementById('delete-form-{{$u->id}}').submit();">
                                                        <i class="fa fa-trash"></i>
                                                    </a>
                                                    <form id="delete-form-{{$u->id}}" action="/unidades/instrutor/{{$u->id}}" method="POST" style="display: none;">
                                                        @method('DELETE')
                                                        @csrf
                                                    </form>
                                                </td>
                ...
                <div class="box-footer d-flex justify-content-center">
                    <div class="col-md-2">
                        <a href="{{route('unidades.instrutor.create')}}" type="button"  class="btn btn-primary botao" id="cadastro">
